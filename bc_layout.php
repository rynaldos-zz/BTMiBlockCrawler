<?php
	function site_header ($title, $auth_list="")
	{
		...
		echo "<head>\n\n";
		echo "	<link rel=\"stylesheet\" type=\"text/css\" href=\"http://fonts.googleapis.com/css?family=Titillium+Web\">\n\n";
		...
		echo " <img src=\"http://i62.tinypic.com/v7xkck.png\">\n";
	...
	//	The page_wrap div is opened in the last line of the site_header function.	
		...
		echo "\n";
		echo "<br>";
		echo "		BlockCrawler Script Originally Created By Jake Paysnoe | Modified By Rynaldo Stoltz for BitMiles \n";
